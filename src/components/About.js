        ...
        <section className=" mt-0 bg-gray-700 rounded-lg lg:flex p-6 opacity-70">
          ...
          <div className="text-lg flex flex-col justify-center">
            ...
            <p className="text-blue-100 text-lg text-2xl lg:pl-3 mt-5">
              ...
              I quit and founded <a target="_blank" className="text-green-200 font-bold" href='http://www.benchmark-employment.com/'>Benchmark Employment Services & Training (BEST, LLC)</a>, 
            ...
            <p className="text-blue-100 text-lg text-2xl lg:pl-3 mt-5">
              Needing a creative outlet to offset social work, I co-founded <a target="_blank" className="text-green-200 font-bold" href='http://www.skylarkhammocks.com/'>Skylark Hammocks</a> with a friend. 
